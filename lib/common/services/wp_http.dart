...
class WPHttpService extends GetxService {
  ...
  Future<Response> get(String url, {Map<String, dynamic>? params, Options? options, CancelToken? cancelToken}) async {
    Options requestOptions = options ?? Options();
    Response response = await _dio.get(url, queryParameters: params, options: requestOptions, cancelToken: cancelToken);
    return response;
  }
  ...
  Future<Response> put(String url, {dynamic data, Options? options, CancelToken? cancelToken}) async {
    var requestOptions = options ?? Options();
    Response response = await _dio.put(url, data: data ?? {}, options: requestOptions, cancelToken: cancelToken);
    return response;
  }

  Future<Response> delete(String url, {dynamic data, Options? options, CancelToken? cancelToken}) async {
    var requestOptions = options ?? Options();
    Response response = await _dio.delete(url, data: data ?? {}, options: requestOptions, cancelToken: cancelToken);
    return response;
  }
}
...
class RequestInterceptors extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    options.headers['sign'] = RequestEncode.generateSignature(time);
      ...
      case DioExceptionType.badResponse: // 服务端自定义错误体处理
        {
          ...
          final errorMessage = BaseResponse.fromJson(response?.data, (data) => data as Map<String, dynamic>);
