...
class LoginButtonWidget extends StatefulWidget {
  /// 按钮样式
  final LoginButtonWidgetVariant variant;
  ...
  const LoginButtonWidget({
    super.key,
    this.variant = LoginButtonWidgetVariant.primary,
  ...
  /// 主要
  const LoginButtonWidget.primary(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.primary;

  /// 次要
  const LoginButtonWidget.secondary(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.secondary;

  // destructive 警告
  const LoginButtonWidget.destructive(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.destructive;

  // outline
  const LoginButtonWidget.outline(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.outline;

  // ghost
  const LoginButtonWidget.ghost(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.ghost;

  // link
  const LoginButtonWidget.link(
    this.text, {
    super.key,
    this.scale = WidgetScale.medium,
    double? width,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.link;

  // icon
  const LoginButtonWidget.icon(
    this.icon, {
    super.key,
    this.scale = WidgetScale.medium,
    this.text,
    ...
    this.elevation,
       ...
       _width = width,
       variant = LoginButtonWidgetVariant.icon;
...
class _LoginButtonWidgetState extends State<LoginButtonWidget> {
  ...
  Color _textColor() {
    ...
    switch (widget.variant) {
      case LoginButtonWidgetVariant.primary:
        color = widget.textColor ?? colorScheme.onPrimary;
        break;
      case LoginButtonWidgetVariant.secondary:
        color = widget.textColor ?? colorScheme.onSecondary;
        break;
      case LoginButtonWidgetVariant.destructive:
        color = widget.textColor ?? colorScheme.onError;
        break;
      case LoginButtonWidgetVariant.outline:
        color = widget.textColor ?? colorScheme.primary;
        break;
      case LoginButtonWidgetVariant.ghost:
      case LoginButtonWidgetVariant.link:
      case LoginButtonWidgetVariant.icon:
  ...
  Widget _buildView() {
    ...
    // 背景、边框
    if (widget.variant != LoginButtonWidgetVariant.icon) {
    ...
    child = child.gestures(
      onTapChange:
          enabled ? (tapStatus) => setState(() => pressed = tapStatus) : null,
      onTap:
          enabled
              ? () {
                widget.onTap?.call();
